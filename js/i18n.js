...
const i18n = {
    ...
    translations: {
        zh: {
            ...
            'watermark-apply-btn': '应用水印',
            'watermark-download-btn': '下载带水印的图片',
            
            // PDF工具
            'pdf-search-placeholder': '🔍 搜索PDF工具...',
            'pdf-basic-tools': 'PDF基础工具',
            'pdf-merge': '合并PDF',
            'pdf-split': '拆分PDF',
            'pdf-compress': '压缩PDF',
            'pdf-edit': '编辑PDF',
        ...
        en: {
            ...
            'watermark-font-size': 'Font Size:',
            'watermark-font-color': 'Font Color:',
            'watermark-position': 'Position:',
            'watermark-opacity': 'Opacity:',
            'watermark-apply-btn': 'Apply Watermark',
            'watermark-download-btn': 'Download Watermarked Image',
            
            // PDF tool
            'pdf-search-placeholder': '🔍 Search PDF Tools...',
            'pdf-basic-tools': 'PDF Basic Tools',
            'pdf-merge': 'Merge PDF',
            'pdf-split': 'Split PDF',

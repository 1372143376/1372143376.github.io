...
const i18n = {
    ...
    translations: {
        zh: {
            ...
            'tool-browser-fingerprint': '浏览器指纹检测',
            'tool-browser-fingerprint-desc': '检测浏览器的各种特征信息，用于浏览器指纹识别',
            'tool-bandwidth': '网络带宽计算',
            'tool-bandwidth-desc': '计算下载时间、所需带宽和网络速度单位转换',
            'tool-bitwise': '按位与计算器',
            'tool-bitwise-desc': '支持二进制、十进制、十六进制的位运算计算',
            'tool-more': '更多工具',
            ...
            'nav-browser-fingerprint': '🔍 浏览器指纹检测',
            'nav-bandwidth': '📊 网络带宽计算',
            'nav-bitwise': '🔢 按位与计算器',
            
            // 按位与计算器工具
            'bitwise-first-number': '第一个数字',
            'bitwise-second-number': '第二个数字',
            'bitwise-calculate': '计算',
            'bitwise-reset': '重置',
            'bitwise-result': '计算结果',
            'bitwise-binary': '二进制',
            'bitwise-decimal': '十进制',
            'bitwise-hex': '十六进制',
            'bitwise-octal': '八进制',
            'bitwise-binary-visual': '二进制可视化',
            'bitwise-binary-visual-desc': '计算后显示二进制位可视化',
            'bitwise-operation-rules': '位运算规则',
            'bitwise-operator': '运算符',
            'bitwise-name': '名称',
            'bitwise-description': '描述',
            'bitwise-example': '示例',
            'bitwise-and': '按位与',
            'bitwise-and-desc': '两个位都为1时结果为1',
            'bitwise-or': '按位或',
            'bitwise-or-desc': '任一为1时结果为1',
            'bitwise-xor': '按位异或',
            'bitwise-xor-desc': '不同时为1',
            'bitwise-not': '按位取反',
            'bitwise-not-desc': '0变1，1变0',
            'bitwise-usage': '使用说明',
            'bitwise-usage-desc': '• 支持二进制、十进制、十六进制输入',
            'bitwise-usage-desc2': '• 自动转换为32位有符号整数进行计算',
            'bitwise-usage-desc3': '• 结果显示多种进制格式',
            'bitwise-usage-desc4': '• 提供二进制位可视化展示',
            
            // 网络带宽计算工具
            'bandwidth-mode-download-time': '下载时间计算',
            'bandwidth-mode-required-bandwidth': '所需带宽计算',
            'bandwidth-mode-unit-convert': '单位转换',
            'bandwidth-download-time': '下载时间计算',
            'bandwidth-download-time-desc': '根据文件大小和下载速度计算所需时间',
            'bandwidth-required-bandwidth': '所需带宽计算',
            'bandwidth-required-bandwidth-desc': '根据文件大小和目标时间计算所需带宽',
            'bandwidth-unit-convert': '单位转换',
            'bandwidth-unit-convert-desc': '网络速度单位相互转换',
            'bandwidth-file-size': '文件大小：',
            'bandwidth-download-speed': '下载速度：',
            'bandwidth-target-time': '目标时间：',
            'bandwidth-input-value': '输入值：',
            'bandwidth-calculate': '开始计算',
            'bandwidth-convert': '转换',
            'bandwidth-result': '计算结果：',
            'bandwidth-convert-result': '转换结果：',
            'bandwidth-reference': '常见网络速度参考',
            'bandwidth-reference-adsl': 'ADSL宽带：',
            'bandwidth-reference-fiber': '光纤宽带：',
            'bandwidth-reference-4g': '4G网络：',
            'bandwidth-reference-5g': '5G网络：',
            'bandwidth-reference-wifi': 'WiFi：',
            'bandwidth-reference-gigabit': '千兆网络：',
            'bandwidth-unit-b': 'B',
            'bandwidth-unit-kb': 'KB',
            'bandwidth-unit-mb': 'MB',
            'bandwidth-unit-gb': 'GB',
            'bandwidth-unit-tb': 'TB',
            'bandwidth-unit-kbps': 'Kbps',
            'bandwidth-unit-mbps': 'Mbps',
            'bandwidth-unit-gbps': 'Gbps',
            'bandwidth-unit-kbs': 'KB/s',
            'bandwidth-unit-mbs': 'MB/s',
            'bandwidth-unit-gbs': 'GB/s',
            'bandwidth-unit-second': '秒',
            'bandwidth-unit-minute': '分钟',
            'bandwidth-unit-hour': '小时',
            'bandwidth-unit-day': '天',
            
            // 浏览器指纹工具
            'browser-basic-info': '基础信息',
            'browser-user-agent': 'User Agent:',
            'browser-language': '语言:',
            'browser-platform': '平台:',
            'browser-screen': '屏幕分辨率:',
            'browser-color-depth': '颜色深度:',
            'browser-time-info': '时区信息',
            'browser-timezone': '时区:',
            'browser-timezone-offset': '时区偏移:',
            'browser-date-time': '当前时间:',
            'browser-webgl-info': 'WebGL 信息',
            'browser-webgl-renderer': '渲染器:',
            'browser-webgl-vendor': '厂商:',
            'browser-webgl-version': '版本:',
            'browser-canvas-info': 'Canvas 指纹',
            'browser-canvas-fingerprint': 'Canvas指纹:',
            'browser-canvas-hash': 'Canvas哈希:',
            'browser-fonts-info': '字体信息',
            'browser-fonts-list': '字体列表:',
            'browser-fonts-count': '字体数量:',
            'browser-plugins-info': '插件信息',
            'browser-plugins-list': '插件列表:',
            'browser-plugins-count': '插件数量:',
            'browser-detect': '检测浏览器指纹',
            'browser-copy-all': '复制所有信息',
            'browser-generate-hash': '生成指纹哈希',
            'browser-fingerprint-hash': '浏览器指纹哈希:',
        ...
        en: {
            ...
            'tool-browser-fingerprint': 'Browser Fingerprint Detection',
            'tool-browser-fingerprint-desc': 'Detect various browser features for browser fingerprinting',
            'tool-bandwidth': 'Network Bandwidth Calculator',
            'tool-bandwidth-desc': 'Calculate download time, required bandwidth and network speed unit conversion',
            'tool-bitwise': 'Bitwise Calculator',
            'tool-bitwise-desc': 'Bitwise operations with binary, decimal, and hexadecimal numbers',
            ...
            'nav-browser-fingerprint': '🔍 Browser Fingerprint Detection',
            'nav-bandwidth': '📊 Network Bandwidth Calculator',
            'nav-bitwise': '🔢 Bitwise Calculator',
            
            // Bitwise calculator tool
            'bitwise-first-number': 'First Number',
            'bitwise-second-number': 'Second Number',
            'bitwise-calculate': 'Calculate',
            'bitwise-reset': 'Reset',
            'bitwise-result': 'Calculation Result',
            'bitwise-binary': 'Binary',
            'bitwise-decimal': 'Decimal',
            'bitwise-hex': 'Hexadecimal',
            'bitwise-octal': 'Octal',
            'bitwise-binary-visual': 'Binary Visualization',
            'bitwise-binary-visual-desc': 'Binary bit visualization after calculation',
            'bitwise-operation-rules': 'Bitwise Operation Rules',
            'bitwise-operator': 'Operator',
            'bitwise-name': 'Name',
            'bitwise-description': 'Description',
            'bitwise-example': 'Example',
            'bitwise-and': 'Bitwise AND',
            'bitwise-and-desc': 'Result is 1 when both bits are 1',
            'bitwise-or': 'Bitwise OR',
            'bitwise-or-desc': 'Result is 1 when either bit is 1',
            'bitwise-xor': 'Bitwise XOR',
            'bitwise-xor-desc': 'Result is 1 when bits are different',
            'bitwise-not': 'Bitwise NOT',
            'bitwise-not-desc': 'Flip 0 to 1 and 1 to 0',
            'bitwise-usage': 'Usage Instructions',
            'bitwise-usage-desc': '• Supports binary, decimal, and hexadecimal input',
            'bitwise-usage-desc2': '• Automatically converts to 32-bit signed integers for calculation',
            'bitwise-usage-desc3': '• Results displayed in multiple base formats',
            'bitwise-usage-desc4': '• Provides binary bit visualization',
            
            // Network bandwidth calculator tool
            'bandwidth-mode-download-time': 'Download Time Calculator',
            'bandwidth-mode-required-bandwidth': 'Required Bandwidth Calculator',
            'bandwidth-mode-unit-convert': 'Unit Converter',
            'bandwidth-download-time': 'Download Time Calculator',
            'bandwidth-download-time-desc': 'Calculate download time based on file size and download speed',
            'bandwidth-required-bandwidth': 'Required Bandwidth Calculator',
            'bandwidth-required-bandwidth-desc': 'Calculate required bandwidth based on file size and target time',
            'bandwidth-unit-convert': 'Unit Converter',
            'bandwidth-unit-convert-desc': 'Network speed unit conversion',
            'bandwidth-file-size': 'File Size:',
            'bandwidth-download-speed': 'Download Speed:',
            'bandwidth-target-time': 'Target Time:',
            'bandwidth-input-value': 'Input Value:',
            'bandwidth-calculate': 'Calculate',
            'bandwidth-convert': 'Convert',
            'bandwidth-result': 'Calculation Result:',
            'bandwidth-convert-result': 'Conversion Result:',
            'bandwidth-reference': 'Common Network Speed Reference',
            'bandwidth-reference-adsl': 'ADSL Broadband:',
            'bandwidth-reference-fiber': 'Fiber Broadband:',
            'bandwidth-reference-4g': '4G Network:',
            'bandwidth-reference-5g': '5G Network:',
            'bandwidth-reference-wifi': 'WiFi:',
            'bandwidth-reference-gigabit': 'Gigabit Network:',
            'bandwidth-unit-b': 'B',
            'bandwidth-unit-kb': 'KB',
            'bandwidth-unit-mb': 'MB',
            'bandwidth-unit-gb': 'GB',
            ...
            'bandwidth-unit-mbs': 'MB/s',
            'bandwidth-unit-gbs': 'GB/s',
            'bandwidth-unit-second': 'seconds',
            'bandwidth-unit-minute': 'minutes',
            'bandwidth-unit-hour': 'hours',
            'bandwidth-unit-day': 'days',
            
            // Browser fingerprint tool
            'browser-basic-info': 'Basic Information',
            'browser-user-agent': 'User Agent:',
            'browser-language': 'Language:',
            'browser-platform': 'Platform:',
            'browser-screen': 'Screen Resolution:',
            'browser-color-depth': 'Color Depth:',
            'browser-time-info': 'Timezone Information',
            'browser-timezone': 'Timezone:',
            'browser-timezone-offset': 'Timezone Offset:',
            'browser-date-time': 'Current Time:',
            'browser-webgl-info': 'WebGL Information',
            'browser-webgl-renderer': 'Renderer:',
            'browser-webgl-vendor': 'Vendor:',
            'browser-webgl-version': 'Version:',
            'browser-canvas-info': 'Canvas Fingerprint',
            'browser-canvas-fingerprint': 'Canvas Fingerprint:',
            'browser-canvas-hash': 'Canvas Hash:',
            'browser-fonts-info': 'Font Information',
            'browser-fonts-list': 'Font List:',
            'browser-fonts-count': 'Font Count:',
            'browser-plugins-info': 'Plugins Information',
            'browser-plugins-list': 'Plugins List:',
            'browser-plugins-count': 'Plugins Count:',
            'browser-detect': 'Detect Browser Fingerprint',
            'browser-copy-all': 'Copy All Information',
            'browser-generate-hash': 'Generate Fingerprint Hash',
            'browser-fingerprint-hash': 'Browser Fingerprint Hash:',
